...
shosho = Movie.create(title: "The Shawshank Redemption", overview: "Framed in the 1940s for double murder, upstanding banker Andy Dufresne begins a new life at the Shawshank prison", poster_url: "https://image.tmdb.org/t/p/original/q6y0Go1tsGEsmtFryDOJo3dEmqu.jpg", rating: 8.7)
...
list_1 = List.create(name: 'First list')
Bookmark.create(comment: 'Au secours', movie: titanic, list: list_1)
Bookmark.create(comment: 'Mamma Mia', movie: ocean, list: list_1)
list_2 = List.create(name: 'Nullos list')
Bookmark.create(comment: 'Très mauvais', movie: shosho, list: list_2)
Bookmark.create(comment: 'Pas bien', movie: wonder, list: list_2)
puts "#{Movie.all.count} movies"
puts "#{List.all.count} lists"
